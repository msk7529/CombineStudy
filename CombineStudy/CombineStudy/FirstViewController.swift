...
class FirstViewController: UIViewController {
    ...
    private lazy var chapter11Btn: commonBtn = {
        let button: commonBtn = .init(title: "Chapter11")
        button.addTarget(self, action: #selector(moveChapter11), for: .touchUpInside)
        return button
    }()
    ...
    private lazy var chapter13Btn: commonBtn = {
        let button: commonBtn = .init(title: "Chapter13")
        button.addTarget(self, action: #selector(moveChapter13), for: .touchUpInside)
        return button
    }()
    ...
    private func initView() {
        ...
        chapter11Btn.topAnchor.constraint(equalTo: chapter10Btn.topAnchor).isActive = true
        ...
        chapter13Btn.topAnchor.constraint(equalTo: chapter12Btn.topAnchor).isActive = true
